<!-- Page pour modifier les exercices d'un entrainement -->
...
<body>
    ...
    if (isset($_POST['mod'])) {
        ...
        AfficherPourModifierEntrainement($_POST['id']);
        echo '</table> <br>';
    ...
    if (isset($_POST['modConfirm'])) {
        ...
        $rep = ModEntrainnement($_POST['id'], $_POST['cat'], $_POST['nbSeries'], $_POST['nbRep'], $_POST['tempo'], $_POST['temps'], $_POST['exercice'], $_POST['numTrain'], $_POST['jour']);
